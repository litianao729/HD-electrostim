...
void setup() {
  ...
  digitalWrite(cmode,HIGH);
}
void loop() {
  // Program 1: (RC skin model current vs frequency)
  //    MATLAB will tell arduino what frequency to output with what amplitude and duration and also which electrodes
  //    Arduino will send output waveform and ADC readings to MATLAB
  //    --> Plot will show input voltage curve, and measured voltage current sense as freq changes
