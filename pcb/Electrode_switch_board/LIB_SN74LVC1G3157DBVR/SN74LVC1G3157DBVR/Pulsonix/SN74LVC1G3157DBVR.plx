...
//345407/1264715/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(compDef "SN74LVC1G3157DBVR" (originalName "SN74LVC1G3157DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "S") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VCC") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "A") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://componentsearchengine.com/Datasheets/1/SN74LVC1G3157DBVR.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "SN74LVC1G3157DBVR.stp")
