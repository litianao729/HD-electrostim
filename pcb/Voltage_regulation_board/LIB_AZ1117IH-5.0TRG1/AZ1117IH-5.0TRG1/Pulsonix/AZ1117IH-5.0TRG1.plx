...
//251370/1264715/2.50/4/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AZ1117IH-5.0TRG1" (originalName "AZ1117IH-5.0TRG1")
	...
	(compDef "AZ1117IH-5.0TRG1" (originalName "AZ1117IH-5.0TRG1") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AZ1117IH-5.0TRG1"))
		...
		(attr "Mouser Part Number" "621-AZ1117IH-5.0TRG1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/AZ1117IH-5.0TRG1?qs=cpo3%2FpBou2jpUVbxjr50ag%3D%3D")
		(attr "Manufacturer_Name" "Diodes Incorporated")
		(attr "Manufacturer_Part_Number" "AZ1117IH-5.0TRG1")
		(attr "Description" "LDO Voltage Regulators LDO BJT HiCurr 1.35A 10Hz to 10KHz")
		(attr "<Hyperlink>" "https://www.diodes.com/assets/Datasheets/AZ1117I.pdf")
		(attr "<Component Height>" "1.7")
		(attr "<STEP Filename>" "AZ1117IH-5.0TRG1.stp")
